window.onload=function () {
  ...
  fetch(popularURL,{
        ...
        contenedor.innerHTML += '<li class="uk-width-3-4"><a href="/movies.detalle?serieId='+data.results[i].id+'"><div class="uk-panel"><img src="'+ poster +  data.results[i].backdrop_path + '" alt=""><div class="uk-position-bottom-center uk-panel"><h3>'+data.results[i].name+'</h3></div></div></a></li>'
        }
